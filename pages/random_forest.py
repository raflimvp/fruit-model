...
#baca model
pred_fruit = pickle.load(open('dataset/fruit_rf.sav', 'rb'))

# judul web
st.title('Prediksi jenis buah metode random forest')
...
if st.button('Prediksi Jenis Buah'):
    ...
    st.success(f"Jenis Buah Yang Diprediksi = {(fruit_pred[0])}")
